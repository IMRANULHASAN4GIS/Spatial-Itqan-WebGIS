...
On supported browsers, select **Install** to add Spatial Itqan to the device.
On iPhone or iPad, use Safari's Share menu and **Add to Home Screen**.

The offline badge means the application shell is available but external maps
and online services may not work.
